...
public class AuditTrail {
    ...
    @JsonIgnoreProperties({"hibernateLazyInitializer", "handler", "receipt", "category", "tenantId", "createdAt", "reconciled", "referenceNumber"})
    private BankTransaction transaction;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "receipt_id")
    @JsonIgnoreProperties({"hibernateLazyInitializer", "handler", "tenantId", "driveFileId", "ocrConfidence", "ocrModeUsed", "createdAt", "category"})
